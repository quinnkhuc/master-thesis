import { BannerSkeleton } from "../components/loop-percentage-skeleton/banner-skeleton.tsx";
import { LargeCardSkeleton, SmallCardSkeleton } from "../components/loop-percentage-skeleton/card-skeleton.tsx";
import { HeaderSkeleton } from "../components/loop-percentage-skeleton/header-skeleton.tsx";
...
// import {IndexSkeleton} from "../components/loop-percentage-skeleton/index-skeleton.tsx";
// import { Index } from "../components/page/index.tsx";

    export const Route = new FileRoute("/loop-percentage-skeleton").createRoute({
    component: LoopPercentageSkeleton,
});

function LoopPercentageSkeleton() {
